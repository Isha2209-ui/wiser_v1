...
import {
  ...
  CalendarDays, Check, ChevronDown, ChevronRight, CircleAlert, CreditCard, FileText, Landmark, LayoutDashboard,
      ...
      <div className="content-wrap">
        ...
        {section === "Overview" && <>
          ...
          <section className="dashboard-grid">
            <div className="panel cashflow-panel"><div className="panel-heading"><div><p className="eyebrow">MONEY IN / MONEY OUT</p><h2>Cash flow</h2><p className="chart-subtitle">Monthly income, expenses, and savings</p></div><button className="select-btn">Last 6 months <ChevronDown size={14} /></button></div><PremiumCashflow data={profile.cashFlow} /></div>
