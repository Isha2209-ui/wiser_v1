...
path = Path('/home/ubuntu/credwise-ai/client/src/pages/Home.tsx')
text = path.read_text()
anchor = 'function Progress({ value, tone = "mint" }: { value: number; tone?: "mint" | "amber" | "violet" }) {'
insert = r'''
...
'''
if 'function PremiumCashflow' not in text:
    text = text.replace(anchor, insert + anchor)
text = text.replace('<div className="chart-area">', '<div className="chart-area">')
path.write_text(text)
print('Added premium chart components')
